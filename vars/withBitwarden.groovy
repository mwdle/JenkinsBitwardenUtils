...
// Optional: bitwardenServerUrl (default: 'https://vault.bitwarden.com'), apiKeyCredentialId (default: 'bitwarden-api-key'), masterPasswordCredentialId (default: 'bitwarden-master-password')
